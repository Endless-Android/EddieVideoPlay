...
public class StateView extends FrameLayout {
    ...
    @IntDef({STATE_CONTENT, STATE_CONTENT_LOADING, STATE_ERROR, STATE_EMPTY, STATE_LOADING})
    ...
    private void initStateView(AttributeSet attrs) {
        ...
        int giveState = a.getInt(R.styleable.StateView_state_current, STATE_CONTENT);
        switch (giveState) {
            case STATE_CONTENT:
    ...
    private boolean isValidContentView(View child) {
        ...
        return child != mLoadingView && child != mErrorView && child != mEmptyView;
    }
}
